package generics;
	...
	import inheritance.ElectronicsStudentt;
	import inheritance.InvalidStudentArgumentException;
	import java.util.HashMap;
	import java.util.Map;
	import java.util.Set;
	import inheritance.Computerscience;
	import inheritance.Course;
	public class StudentMain {
		...
		public void runApp() {
			try {
				...
				ElectronicsStudentt student1 = new ElectronicsStudentt(name1, 21, true, "multimeter");
				student1.setCourse(course1);
				Computerscience student2 = new ComputerScienceStudent(name2, 21, true, "dell");
				...
				ElectronicsStudentt student4 = new ElectronicsStudentt(name4, 22, true, "diode");
			    ...
			    if(fetched instanceof Computerscience) {
			     Computerscience fetchedCsStudent=(Computerscience) fetched;
			     display(fetchedCsStudent);
			    }
			    if(fetched instanceof ElectronicsStudentt) {
				     ElectronicsStudentt fetchedEceStudent=(ElectronicsStudentt) fetched;
		...
		public void display(ElectronicsStudentt student) {
			checkNull(student);
		...
		public void display(Computerscience student) {
			checkNull(student);
			displayStudent(student);
